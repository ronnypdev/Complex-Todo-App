...
export default function iconMoon({
  ...
  return (
      <svg fill={fillColor} stroke={stroke} className={hoverState} height="18px" width="18px" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" viewBox="0 0 306.637 306.637" xmlSpace="preserve">
      <g>
        <g>
